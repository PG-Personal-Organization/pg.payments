...
public class DistributedAccountTransfersPlugin extends AccountTransfersPlugin {

    public DistributedAccountTransfersPlugin(final AccountTransfersParsingComponentsProvider parsingComponentsProvider,
    ...
    public @NonNull PluginCode getCode() {
        return new PluginCode("DISTRIBUTED_" + super.getCode().code());
    }
}
