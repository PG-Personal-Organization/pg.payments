...
public class SimpleSelfStoringAccountTransfersPlugin extends AccountTransfersPlugin {

    public SimpleSelfStoringAccountTransfersPlugin(final AccountTransfersParsingComponentsProvider parsingComponentsProvider,
    ...
    public @NonNull PluginCode getCode() {
        return new PluginCode("SIMPLE_SELF_STORING_" + super.getCode().code());
    }
}
