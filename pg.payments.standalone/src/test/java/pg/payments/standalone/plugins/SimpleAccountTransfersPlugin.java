...
public class SimpleAccountTransfersPlugin extends AccountTransfersPlugin {

    public SimpleAccountTransfersPlugin(final AccountTransfersParsingComponentsProvider parsingComponentsProvider,
    ...
    public @NonNull PluginCode getCode() {
        return new PluginCode("SIMPLE_" + super.getCode().code());
    }
}
